function cargarProductos(categoria = 'todos') {
    ...
    // Nombres descriptivos para cada categoría (INCLUYE LA NUEVA CATEGORÍA ROPA)
    const nombresCategorias = {
        ...
        'ropa': 'Ropa y Calzado'  // 👈 NUEVA CATEGORÍA AGREGADA
    };
    ...
    productosFiltrados.forEach(producto => {
        ...
        if (producto.tieneFoto && producto.foto) {
            ...
            // Iconos por categoría (con el nuevo icono para ropa)
            const iconosPorCategoria = {
                ...
                'ferreteria': 'fa-tools',
                'deportes': 'fa-futbol',
                'ropa': 'fa-tshirt'  // 👈 ICONO PARA LA NUEVA CATEGORÍA
            };
            const icono = iconosPorCategoria[producto.categoria] || 'fa-box-open';
            imagenHTML = `<i class="fas ${icono}"></i>`;
        }
        
        // Capitalizar nombre de categoría para mostrar (INCLUYE ROPA)
        const nombreCategoria = {
            ...
            'deportes': 'Deportes',
            'ropa': 'Ropa y Calzado'  // 👈 NUEVA CATEGORÍA
